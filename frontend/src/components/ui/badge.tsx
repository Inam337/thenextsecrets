...
const badgeVariants = cva(
  ...
  px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 
  -1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 
